...
- General diagnostic status, reconnect count, connection details, scald-protection diagnostics, ODB protocol diagnostics, device alarm and device information.
