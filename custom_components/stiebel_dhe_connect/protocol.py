...
TEMPERATURE_MAX_OVERRIDE_GET_COMMAND = "get:ste.common.temperature:maxOverride"
TEMPERATURE_MAX_OVERRIDE_SET_COMMAND = "set:ste.common.temperature:maxOverride"
TEMPERATURE_MAX_OVERRIDE_ASSIGN_COMMAND = "assign:ste.common.temperature:maxOverride"
...
WINTER_PICK_ME_UP_PROGRAM_ID = 2
SUMMER_FITNESS_PROGRAM_ID = 3
CIRCULATION_BOOST_PROGRAM_ID = 4
...
OPTIONAL_STARTUP_APP_REQUEST_COMMANDS = (
    ...
    *APP_STARTUP_REQUEST_COMMANDS,
    TEMPERATURE_MAX_OVERRIDE_GET_COMMAND,
)
OPTIONAL_STARTUP_ODB_IDS: tuple[int, ...] = ()

TEMPERATURE_MAX_OVERRIDE_COMMANDS = {
    TEMPERATURE_MAX_OVERRIDE_GET_COMMAND,
    TEMPERATURE_MAX_OVERRIDE_SET_COMMAND,
