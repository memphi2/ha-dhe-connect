...
SENSOR_DESCRIPTIONS: tuple[StiebelDHESensorEntityDescription, ...] = (
    ...
    StiebelDHESensorEntityDescription(
        key="app_volume_format",
        translation_key="app_volume_format",
        icon="mdi:format-list-numbered",
        entity_category=EntityCategory.DIAGNOSTIC,
        odb_id=ID_APP_VOLUME_FORMAT,
        source_command="set:ste.app.consumption:volumeFormat",
    ),
    StiebelDHESensorEntityDescription(
        key="app_language",
        ...
        icon="mdi:translate",
        entity_category=EntityCategory.DIAGNOSTIC,
        odb_id=ID_APP_LANGUAGE,
        source_command="set:ste.common.language:value",
    ),
    StiebelDHESensorEntityDescription(
        key="app_currency",
    ...
    StiebelDHESensorEntityDescription(
        key="app_view",
        translation_key="app_view",
        icon="mdi:view-dashboard-outline",
        entity_category=EntityCategory.DIAGNOSTIC,
        odb_id=ID_APP_VIEW,
        source_command="set:ste.common.view:value",
    ),
    StiebelDHESensorEntityDescription(
    ...
    StiebelDHESensorEntityDescription(
        ...
        translation_key="time_clock_format",
        icon="mdi:clock-outline",
        entity_category=EntityCategory.DIAGNOSTIC,
        odb_id=ID_TIME_CLOCK_FORMAT,
        source_command="set:ste.common.time:format_clock",
    ),
    StiebelDHESensorEntityDescription(
        key="device_info",
